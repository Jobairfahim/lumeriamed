...
const SPECIALTIES = [
  {
    ...
    desc: "Cardiology, gastroenterology, endocrinology, respiratory medicine, and more.",
  },
  {
    title: "Surgery",
    desc: "General surgery, orthopaedics, neurosurgery, and minimally invasive procedures.",
  },
  {
    title: "Paediatrics",
    desc: "Neonatology, paediatric emergency, and developmental medicine.",
  },
  {
    title: "Emergency Medicine",
    desc: "Fast-paced departments in major urban hospitals with diverse case presentations.",
  },
  {
    title: "Obstetrics & Gynaecology",
    desc: "Prenatal care, labour & delivery, gynaecological procedures, and reproductive health.",
  },
  {
  ...
  {
    title: "Oncology",
    desc: "Medical and radiation oncology at cancer centres with cutting-edge treatments.",
  },
  {
    title: "Radiology & Imaging",
    desc: "CT, MRI, ultrasound, and interventional radiology at leading imaging centres.",
  },
  {
    title: "Psychiatry",
    desc: "Inpatient and outpatient psychiatry and community mental health programmes.",
  },
];
    ...
    <div className="pt-16 min-h-screen bg-white">
      ...
      <div className="bg-brand-light py-14 md:py-20 text-center px-4 border-b border-brand-border">
        ...
        <p className="text-brand-slate text-sm md:text-base max-w-lg mx-auto leading-relaxed mb-7">
          ...
          based on specialty interests, experience level, and career goals.
          Every placement is personally curated — no generic listings.
        </p>
        <button
            ...
            {[
              {
                ...
                desc: "Tell us about your specialty interests, preferred dates, language skills, and goals.",
              },
              {
                image: "matchings",
                title: "Personal Matching",
                desc: "Our team reviews your profile and matches you with suitable hospitals from our network.",
              },
              {
                image: "confirmation",
                title: "Confirmation",
              ...
              },
              {
                ...
                desc: "Complete preparations with our support and start your transformative clinical experience.",
              },
            ].map((s, index) => (
              <div
                key={index}
                className="bg-brand-light p-6 rounded-2xl text-center"
              >
                ...
                <h3 className="font-semibold text-brand-navy text-base mb-2">
                  {s.title}
                </h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {SPECIALTIES.map((s) => (
              <div
                key={s.title}
                className="group bg-white p-6 rounded-2xl border border-brand-border hover:bg-brand-teal transition-colors shadow-sm cursor-pointer"
              >
                <h3 className="font-semibold text-brand-navy text-base mb-2 group-hover:text-white transition-colors">
                  {s.title}
                </h3>
                <p className="text-brand-slate text-sm leading-relaxed group-hover:text-white transition-colors">
                  {s.desc}
                </p>
              </div>
            ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-brand-slate text-sm md:text-base leading-relaxed mb-5">
              <li className="flex gap-3">
                ...
                <span>
                  University-affiliated teaching hospitals with dedicated
              ...
              <li className="flex gap-3">
                <span className="mt-2 h-2 w-2 rounded-full bg-brand-teal shrink-0" />
                <span>
                  Specialist centres of excellence in various medical fields
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-2 w-2 rounded-full bg-brand-teal shrink-0" />
                <span>
                  Hospitals with English-speaking staff to ensure smooth
                  communication
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-2 w-2 rounded-full bg-brand-teal shrink-0" />
                <span>
                  Traditional Chinese medicine clinics, offering a unique blend
                  of Eastern and Western medical practices
                </span>
              </li>
            </ul>
            <p className="text-brand-slate text-sm md:text-base leading-relaxed">
              Each placement is individually arranged based on your specific
              requirements, ensuring the best possible match for your
