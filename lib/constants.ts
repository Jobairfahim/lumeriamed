...
export const WHY_CHOOSE_FEATURES = [
  ...
  },
  {
    ...
    description: "Learn from experienced Chinese physicians and gain insights into Eastern medical practices and approaches.",
    highlight: true,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "Comprehensive support including accommodation assistance, visa guidance, and 24/7 emergency contact throughout your placement.",
    highlight: false,
  },
] as const;
